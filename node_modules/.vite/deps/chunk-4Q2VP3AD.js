...
var GridRootPropsContext = React.createContext(void 0);
if (true) {
...
var useGridRootProps = () => {
  const contextValue = React2.useContext(GridRootPropsContext);
  if (!contextValue) {
...
var GridApiContext = React3.createContext(void 0);
if (true) {
...
function useGridApiContext() {
  const apiRef = React4.useContext(GridApiContext);
  if (apiRef === void 0) {
...
var GridPrivateApiContext = React8.createContext(void 0);
if (true) {
  GridPrivateApiContext.displayName = "GridPrivateApiContext";
}
function useGridPrivateApiContext() {
  const privateApiRef = React8.useContext(GridPrivateApiContext);
...
var GridMainContainer = React9.forwardRef((props, ref) => {
  var _rootProps$experiment;
  const rootProps = useGridRootProps();
...
function GridBody(props) {
  ...
  const columnHeadersRef = React10.useRef(null);
  const columnsContainerRef = React10.useRef(null);
  const virtualScrollerRef = React10.useRef(null);
...
function GridColumnHeaderMenu({
  ...
  return (0, import_jsx_runtime25.jsx)(GridMenu, {
    placement: `bottom-${colDef.align === "right" ? "start" : "end"}`,
    open,
    target,
    onClose: hideMenu,
    onExited,
    children: (0, import_jsx_runtime25.jsx)(ContentComponent, _extends({
      colDef,
      hideMenu,
      open,
      id: columnMenuId,
...
var ColumnHeaderInnerTitle = React33.forwardRef(function ColumnHeaderInnerTitle2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded19);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses16(rootProps);
  return (0, import_jsx_runtime26.jsx)(GridColumnHeaderTitleRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
function GridColumnHeaderTitle(props) {
  ...
  const rootProps = useGridRootProps();
  const titleRef = React33.useRef(null);
  const [tooltip, setTooltip] = React33.useState("");
  const handleMouseOver = React33.useCallback(() => {
  ...
  return (0, import_jsx_runtime26.jsx)(rootProps.slots.baseTooltip, _extends({
    title: description || tooltip
  }, (_rootProps$slotProps = rootProps.slotProps) == null ? void 0 : _rootProps$slotProps.baseTooltip, {
    children: (0, import_jsx_runtime26.jsx)(ColumnHeaderInnerTitle, {
...
function GridColumnHeaderSeparatorRaw(props) {
  ...
  const stopClick = React34.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
    (0, import_jsx_runtime27.jsx)("div", _extends({
      className: classes.root,
      style: {
        minHeight: height,
      ...
      onClick: stopClick,
      children: (0, import_jsx_runtime27.jsx)(rootProps.slots.columnResizeIcon, {
        className: classes.icon
      })
    }))
  );
}
var GridColumnHeaderSeparator = React34.memo(GridColumnHeaderSeparatorRaw);
...
var ColumnHeaderMenuIcon = React35.memo((props) => {
  ...
  const handleMenuIconClick = React35.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  ...
  return (0, import_jsx_runtime28.jsx)("div", {
    className: classes.root,
    children: (0, import_jsx_runtime28.jsx)(rootProps.slots.baseTooltip, _extends({
      title: apiRef.current.getLocaleText("columnMenuLabel"),
      enterDelay: 1e3
    }, (_rootProps$slotProps = rootProps.slotProps) == null ? void 0 : _rootProps$slotProps.baseTooltip, {
      children: (0, import_jsx_runtime28.jsx)(rootProps.slots.baseIconButton, _extends({
        ref: iconButtonRef,
        tabIndex: -1,
        ...
        children: (0, import_jsx_runtime28.jsx)(rootProps.slots.columnMenuIcon, {
          fontSize: "small"
        })
      }))
    }))
...
function GridColumnMenuManageItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showColumns = React49.useCallback((event) => {
    onClick(event);
...
function GridColumnMenuColumnsItem(props) {
  return (0, import_jsx_runtime44.jsxs)(React50.Fragment, {
...
function GridColumnMenuFilterItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showFilter = React51.useCallback((event) => {
    onClick(event);
...
var useGridColumnMenuSlots = (props) => {
  ...
  const processedComponents = React53.useMemo(() => _extends({}, defaultSlots2, slots), [defaultSlots2, slots]);
  const processedSlotProps = React53.useMemo(() => {
  ...
  const userItems = React53.useMemo(() => {
...
var useGridVirtualScroller = (props) => {
  ...
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  const renderZoneRef = React87.useRef(null);
  const rootRef = React87.useRef(null);
  const handleRef = useForkRef(ref, rootRef);
  const [renderContext, setRenderContextState] = React87.useState(null);
  const prevRenderContext = React87.useRef(renderContext);
  const scrollPosition = React87.useRef({
    top: 0,
    left: 0
  });
  const [containerDimensions, setContainerDimensions] = React87.useState({
    width: null,
    height: null
  });
  const prevTotalWidth = React87.useRef(columnsTotalWidth);
  const [hoveredRowId, setHoveredRowId] = React87.useState(null);
  const rowStyleCache = React87.useRef(/* @__PURE__ */ Object.create(null));
  const prevGetRowProps = React87.useRef();
  const prevRootRowStyle = React87.useRef();
  const getRenderedColumnsRef = React87.useRef(defaultMemoize((columns, firstColumnToRender, lastColumnToRender, minFirstColumn, maxLastColumn, indexOfColumnWithFocusedCell2) => {
  ...
  const indexOfColumnWithFocusedCell = React87.useMemo(() => {
    if (cellFocus !== null) {
      return visibleColumns.findIndex((column) => column.field === cellFocus.field);
    }
    return -1;
  }, [cellFocus, visibleColumns]);
  const computeRenderContext = React87.useCallback(() => {
    if (!enabled) {
      return {
        firstRowIndex: 0,
  ...
  const updateRenderZonePosition = React87.useCallback((nextRenderContext) => {
    const [firstRowToRender, lastRowToRender] = getRenderableIndexes({
  ...
  const getRenderContext = React87.useCallback(() => prevRenderContext.current, []);
  const setRenderContext = React87.useCallback((nextRenderContext) => {
  ...
  const indexOfRowWithFocusedCell = React87.useMemo(() => {
    if (cellFocus !== null) {
  ...
  const getRows = (params = {
    ...
    for (let i = 0; i < renderedRows.length; i += 1) {
      ...
      const _ref2 = typeof getRowProps === "function" && getRowProps(id, model) || {}, {
        style: rowStyle
      } = _ref2, rowProps = _objectWithoutPropertiesLoose(_ref2, _excluded212);
      ...
      rows.push((0, import_jsx_runtime93.jsx)(rootProps.slots.row, _extends({
        row: model,
        rowId: id,
        focusedCellColumnIndexNotInRange,
  ...
  const contentSize = React87.useMemo(() => {
  ...
  const rootStyle = React87.useMemo(() => {
    const style = {};
...
function GridColumnGroupHeader(props) {
  ...
  const renderParams = React88.useMemo(() => ({
    groupId,
    headerName,
    description,
    depth,
  ...
  const publish = React88.useCallback(
    (eventName) => (event) => {
      if (isEventTargetInPortal(event)) {
        return;
      }
...
var useGridColumnHeaders = (props) => {
  ...
  const theme = useTheme();
  const [dragCol, setDragCol] = React89.useState("");
  const [resizeCol, setResizeCol] = React89.useState("");
  const apiRef = useGridPrivateApiContext();
  const hasVirtualization = useGridSelector(apiRef, gridVirtualizationColumnEnabledSelector);
  const rootProps = useGridRootProps();
  const innerRef = React89.useRef(null);
  const handleInnerRef = useForkRef(innerRefProp, innerRef);
  const [renderContext, setRenderContextRaw] = React89.useState(null);
  const prevRenderContext = React89.useRef(renderContext);
  const prevScrollLeft = React89.useRef(0);
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  const totalHeaderHeight = getTotalHeaderHeight(apiRef, rootProps.columnHeaderHeight);
  const headerHeight = Math.floor(rootProps.columnHeaderHeight * densityFactor);
  const setRenderContext = React89.useCallback((nextRenderContext) => {
  ...
  const getFirstColumnIndexToRenderRef = React89.useRef(defaultMemoize(getFirstColumnIndexToRender, {
    equalityCheck: (a, b) => ["firstColumnIndex", "minColumnIndex", "columnBuffer"].every((key) => a[key] === b[key])
  }));
  const updateInnerPosition = React89.useCallback((nextRenderContext) => {
    const [firstRowToRender, lastRowToRender] = getRenderableIndexes({
      firstIndex: nextRenderContext.firstRowIndex,
      lastIndex: nextRenderContext.lastRowIndex,
      minFirstIndex: 0,
  ...
  const handleScroll = React89.useCallback(({
    left,
  ...
  const handleColumnResizeStart = React89.useCallback((params) => setResizeCol(params.field), []);
  const handleColumnResizeStop = React89.useCallback(() => setResizeCol(""), []);
  const handleColumnReorderStart = React89.useCallback((params) => setDragCol(params.field), []);
  const handleColumnReorderStop = React89.useCallback(() => setDragCol(""), []);
  ...
  const getColumnHeaders = (params, other = {}) => {
    ...
    for (let i = 0; i < renderedColumns.length; i += 1) {
      ...
      columns.push((0, import_jsx_runtime95.jsx)(GridColumnHeaderItem, _extends({}, sortColumnLookup[colDef.field], {
        columnMenuOpen: open,
    ...
    return (0, import_jsx_runtime95.jsx)(GridColumnHeaderRow, {
      role: "row",
  ...
  const getColumnGroupHeaders = (params) => {
    ...
    headerToRender.forEach((depthInfo, depthIndex) => {
      columns.push((0, import_jsx_runtime95.jsx)(GridColumnHeaderRow, {
        style: {
...
var GridBaseColumnHeaders = React90.forwardRef(function GridColumnHeaders(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded54);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses34(rootProps);
  return (0, import_jsx_runtime96.jsx)(GridColumnHeadersRoot, _extends({
    ref,
    className: clsx_default(className, classes.root),
    ownerState: rootProps
  }, other, {
...
var GridColumnHeadersInner = React91.forwardRef(function GridColumnHeadersInner2(props, ref) {
  var _apiRef$current$getRo, _apiRef$current$getRo2;
  const {
    isDragging,
    className
  ...
  return (0, import_jsx_runtime97.jsx)(GridColumnHeadersInnerRoot, _extends({
    ref,
    className: clsx_default(className, classes.root),
    ownerState
  }, other));
...
var GridColumnHeaders2 = React92.forwardRef(function GridColumnsHeaders(props, ref) {
  const {
    innerRef,
    visibleColumns,
    sortColumnLookup,
  ...
  return (0, import_jsx_runtime99.jsx)(GridBaseColumnHeaders, _extends({
    ref
  }, getRootProps(other), {
    children: (0, import_jsx_runtime98.jsxs)(GridColumnHeadersInner, _extends({
      isDragging
    }, getInnerProps(), {
...
var GridNoResultsOverlay = React93.forwardRef(function GridNoResultsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridColumnUnsortedIcon = React94.memo(function GridColumnHeaderSortIcon2(props) {
  const {
    sortingOrder
  ...
  return Icon ? (0, import_jsx_runtime101.jsx)(Icon, _extends({}, other)) : null;
});
...
function MUISelectOption(_ref) {
  ...
  if (native) {
    return (0, import_jsx_runtime102.jsx)("option", _extends({}, props));
  }
  return (0, import_jsx_runtime102.jsx)(MenuItem_default, _extends({}, props));
}
...
function useProps(allProps) {
  return React96.useMemo(() => {
    const {
      components,
      componentsProps
    } = allProps, themedProps = _objectWithoutPropertiesLoose(allProps, _excluded59);
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React97.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React97.useMemo(() => computeSlots({
    defaultSlots,
...
var GridVirtualScroller = React98.forwardRef(function GridVirtualScroller2(props, ref) {
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses36(rootProps);
  return (0, import_jsx_runtime103.jsx)(VirtualScrollerRoot, _extends({
    ref
  }, props, {
...
var useUtilityClasses37 = (props, overflowedContent) => {
  const {
    classes
  } = props;
  const slots = {
...
var GridVirtualScrollerContent = React99.forwardRef(function GridVirtualScrollerContent2(props, ref) {
  var _props$style;
  const rootProps = useGridRootProps();
  const overflowedContent = !rootProps.autoHeight && ((_props$style = props.style) == null ? void 0 : _props$style.minHeight) === "auto";
  const classes = useUtilityClasses37(rootProps, overflowedContent);
  return (0, import_jsx_runtime104.jsx)(VirtualScrollerContentRoot, _extends({
    ref
  }, props, {
    ownerState: rootProps,
    className: clsx_default(classes.root, props.className)
...
var GridVirtualScrollerRenderZone = React100.forwardRef(function GridVirtualScrollerRenderZone2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded60);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses38(rootProps);
  return (0, import_jsx_runtime105.jsx)(VirtualScrollerRenderZoneRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
var useGridRegisterPipeProcessor = (apiRef, group, callback) => {
  const cleanup = React101.useRef();
  const id = React101.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React101.useCallback(() => {
...
var useGridPipeProcessing = (apiRef) => {
  const processorsCache = React102.useRef({});
  const isRunning = React102.useRef(false);
  const runAppliers = React102.useCallback((groupCache) => {
  ...
  const registerPipeProcessor = React102.useCallback((group, id, processor) => {
  ...
  const registerPipeApplier = React102.useCallback((group, id, applier) => {
    if (!processorsCache.current[group]) {
      processorsCache.current[group] = {
        processors: /* @__PURE__ */ new Map(),
        appliers: {}
  ...
  const requestPipeProcessorsApplication = React102.useCallback((group) => {
    const groupCache = processorsCache.current[group];
    runAppliers(groupCache);
  }, [runAppliers]);
  const applyPipeProcessors = React102.useCallback((...args) => {
...
function useGridApiInitialization(inputApiRef, props) {
  const publicApiRef = React106.useRef();
  const privateApiRef = React106.useRef();
...
var useGridStateInitialization = (apiRef, props) => {
  const controlStateMapRef = React109.useRef({});
  const [, rawForceUpdate] = React109.useState();
  const registerControlState = React109.useCallback((controlStateItem) => {
    controlStateMapRef.current[controlStateItem.stateId] = controlStateItem;
  }, []);
  const setState = React109.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React109.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React109.useCallback(() => rawForceUpdate(() => apiRef.current.state), [apiRef]);
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React110.useCallback((event) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React111.useCallback((field) => {
  ...
  const hideColumnMenu = React111.useCallback(() => {
  ...
  const toggleColumnMenu = React111.useCallback((field) => {
...
function useGridColumns(apiRef, props) {
  ...
  const previousColumnsProp = React112.useRef(props.columns);
  const previousColumnTypesProp = React112.useRef(columnTypes);
  ...
  const setGridColumnsState = React112.useCallback((columnsState) => {
    logger.debug("Updating columns state.");
    apiRef.current.setState(mergeColumnsState(columnsState));
    apiRef.current.forceUpdate();
    apiRef.current.publishEvent("columnsChange", columnsState.orderedFields);
  }, [logger, apiRef]);
  const getColumn = React112.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React112.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React112.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnIndex = React112.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React112.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React112.useCallback((model) => {
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React112.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
      columnTypes,
  ...
  const setColumnVisibility = React112.useCallback((field, isVisible) => {
  ...
  const getColumnIndexRelativeToVisibleColumns = React112.useCallback((field) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
    return allColumns.findIndex((col) => col === field);
  }, [apiRef]);
  const setColumnIndex = React112.useCallback((field, targetIndexPosition) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
  ...
  const setColumnWidth = React112.useCallback((field, width) => {
    var _apiRef$current$getRo, _apiRef$current$getRo2;
  ...
  const preferencePanelPreProcessing = React112.useCallback((initialValue, value) => {
    if (value === GridPreferencePanelsValue.columns) {
      var _props$slotProps;
      const ColumnsPanel = props.slots.columnsPanel;
      return (0, import_jsx_runtime106.jsx)(ColumnsPanel, _extends({}, (_props$slotProps = props.slotProps) == null ? void 0 : _props$slotProps.columnsPanel));
    }
    return initialValue;
  }, [props.slots.columnsPanel, (_props$slotProps2 = props.slotProps) == null ? void 0 : _props$slotProps2.columnsPanel]);
  const addColumnMenuItems = React112.useCallback((columnMenuItems) => {
  ...
  const prevInnerWidth = React112.useRef(null);
  ...
  const hydrateColumns = React112.useCallback(() => {
...
var useGridColumnSpanning = (apiRef) => {
  const lookup = React113.useRef({});
  const setCellColSpanInfo = React113.useCallback((rowId, columnIndex, cellColSpanInfo) => {
  ...
  const getCellColSpanInfo = React113.useCallback((rowId, columnIndex) => {
    var _lookup$current$rowId;
    return (_lookup$current$rowId = lookup.current[rowId]) == null ? void 0 : _lookup$current$rowId[columnIndex];
  }, []);
  const calculateCellColSpan = React113.useCallback((params) => {
    const {
      columnIndex,
      rowId,
      minFirstColumnIndex,
  ...
  const calculateColSpan = React113.useCallback(({
    rowId,
    minFirstColumn,
    maxLastColumn,
    columns
  ...
  const handleColumnReorderChange = React113.useCallback(() => {
    lookup.current = {};
  }, []);
...
var useGridColumnGrouping = (apiRef, props) => {
  ...
  const getColumnGroupPath = React114.useCallback((field) => {
    var _unwrappedGroupingMod3;
    const unwrappedGroupingModel = gridColumnGroupsUnwrappedModelSelector(apiRef);
    return (_unwrappedGroupingMod3 = unwrappedGroupingModel[field]) != null ? _unwrappedGroupingMod3 : [];
  }, [apiRef]);
  const getAllGroupDetails = React114.useCallback(() => {
  ...
  const handleColumnIndexChange = React114.useCallback(() => {
  ...
  const updateColumnGroupingState = React114.useCallback((columnGroupingModel) => {
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const addExportMenuButtons = React116.useCallback((initialValue, options) => {
    ...
    return [...initialValue, {
      component: (0, import_jsx_runtime107.jsx)(GridCsvExportMenuItem, {
...
`;
  ...
  const addExportMenuButtons = React118.useCallback((initialValue, options) => {
    ...
    return [...initialValue, {
      component: (0, import_jsx_runtime108.jsx)(GridPrintExportMenuItem, {
...
var useGridFilter = (apiRef, props) => {
  ...
  const preferencePanelPreProcessing = React119.useCallback((initialValue, value) => {
    if (value === GridPreferencePanelsValue.filters) {
      ...
      return (0, import_jsx_runtime109.jsx)(FilterPanel, _extends({}, (_props$slotProps = props.slotProps) == null ? void 0 : _props$slotProps.filterPanel));
    }
    return initialValue;
...
var useGridFocus = (apiRef, props) => {
  ...
  const getColumnGroupHeaderFocus = React120.useCallback(() => unstable_gridFocusColumnGroupHeaderSelector(apiRef), [apiRef]);
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hideTimeout = React122.useRef();
  const immediateTimeout = React122.useRef();
  const hidePreferences = React122.useCallback(() => {
  ...
  const doNotHidePanel = React122.useCallback(() => {
    immediateTimeout.current = setTimeout(() => clearTimeout(hideTimeout.current), 0);
  }, []);
  const hidePreferencesDelayed = React122.useCallback(() => {
    hideTimeout.current = setTimeout(hidePreferences, 100);
  }, [hidePreferences]);
  const showPreferences = React122.useCallback((newValue, panelId, labelId) => {
...
var useGridCellEditing = (apiRef, props) => {
  const [cellModesModel, setCellModesModel] = React123.useState({});
  const cellModesModelRef = React123.useRef(cellModesModel);
  const prevCellModesModel = React123.useRef({});
  const {
    processRowUpdate,
  ...
  const throwIfNotEditable = React123.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React123.useCallback((id, field, mode) => {
    if (apiRef.current.getCellMode(id, field) !== mode) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React123.useCallback((params, event) => {
  ...
  const handleCellFocusOut = React123.useCallback((params, event) => {
  ...
  const handleCellEditStart = React123.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleCellEditStop = React123.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const getCellMode = React123.useCallback((id, field) => {
  ...
  const updateFieldInCellModesModel = React123.useCallback((id, field, newProps) => {
  ...
  const updateOrDeleteFieldState = React123.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
  ...
  const startCellEditMode = React123.useCallback((params) => {
    const {
      id,
      field
    } = params, other = _objectWithoutPropertiesLoose(params, _excluded62);
  ...
  const stopCellEditMode = React123.useCallback((params) => {
    const {
      id,
      field
  ...
  const setCellEditingEditCellValue = React123.useCallback(async (params) => {
  ...
  const getRowWithUpdatedValuesFromCellEditing = React123.useCallback((id, field) => {
    const column = apiRef.current.getColumn(field);
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
...
var useGridRowEditing = (apiRef, props) => {
  const [rowModesModel, setRowModesModel] = React124.useState({});
  const rowModesModelRef = React124.useRef(rowModesModel);
  const prevRowModesModel = React124.useRef({});
  const focusTimeout = React124.useRef(null);
  const nextFocusedCell = React124.useRef(null);
  const {
    processRowUpdate,
    onProcessRowUpdateError,
  ...
  const throwIfNotInMode = React124.useCallback((id, mode) => {
  ...
  const handleCellFocusIn = React124.useCallback((params) => {
  ...
  const handleRowEditStart = React124.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleRowEditStop = React124.useCallback((params) => {
    const {
      id,
      reason,
      field
  ...
  const getRowMode = React124.useCallback((id) => {
    if (props.editMode === GridEditModes.Cell) {
  ...
  const updateRowInRowModesModel = React124.useCallback((id, newProps) => {
  ...
  const updateOrDeleteRowState = React124.useCallback((id, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
  ...
  const startRowEditMode = React124.useCallback((params) => {
    const {
      id
    } = params, other = _objectWithoutPropertiesLoose(params, _excluded63);
  ...
  const stopRowEditMode = React124.useCallback((params) => {
    const {
      id
  ...
  const setRowEditingEditCellValue = React124.useCallback((params) => {
    const {
      id,
      field,
      value,
  ...
  const getRowWithUpdatedValuesFromRowEditing = React124.useCallback((id) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
    if (!editingState[id]) {
      return apiRef.current.getRow(id);
...
var useGridEditing = (apiRef, props) => {
  ...
  const debounceMap = React125.useRef({});
  const {
    isCellEditable: isCellEditableProp
  } = props;
  const isCellEditable = React125.useCallback((params) => {
    if (isAutoGeneratedRow(params.rowNode)) {
      return false;
    }
  ...
  const runPendingEditCellValueMutation = React125.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React125.useCallback((params) => {
    const {
      id,
      field,
      debounceMs
  ...
  const getRowWithUpdatedValues = React125.useCallback((id, field) => {
    return props.editMode === GridEditModes.Cell ? apiRef.current.getRowWithUpdatedValuesFromCellEditing(id, field) : apiRef.current.getRowWithUpdatedValuesFromRowEditing(id);
  }, [apiRef, props.editMode]);
  const getEditCellMeta = React125.useCallback((id, field) => {
...
var useGridRows = (apiRef, props) => {
  ...
  const lastUpdateMs = React126.useRef(Date.now());
  const timeout = useTimeout();
  const getRow = React126.useCallback((id) => {
  ...
  const getRowId = React126.useCallback((row) => {
  ...
  const lookup = React126.useMemo(() => currentPage.rows.reduce((acc, {
    id
  }, index) => {
    acc[id] = index;
    return acc;
  }, {}), [currentPage.rows]);
  const throttledRowsChange = React126.useCallback(({
    cache,
    throttle
  }) => {
    const run = () => {
  ...
  const setRows = React126.useCallback((rows) => {
  ...
  const updateRows = React126.useCallback((updates) => {
  ...
  const getRowModels = React126.useCallback(() => {
  ...
  const getRowsCount = React126.useCallback(() => gridRowCountSelector(apiRef), [apiRef]);
  const getAllRowIds = React126.useCallback(() => gridDataRowIdsSelector(apiRef), [apiRef]);
  const getRowIndexRelativeToVisibleRows = React126.useCallback((id) => lookup[id], [lookup]);
  const setRowChildrenExpansion = React126.useCallback((id, isExpanded) => {
  ...
  const getRowNode = React126.useCallback((id) => {
    var _ref;
    return (_ref = gridRowTreeSelector(apiRef)[id]) != null ? _ref : null;
  }, [apiRef]);
  const getRowGroupChildren = React126.useCallback(({
  ...
  const setRowIndex = React126.useCallback((rowId, targetIndex) => {
  ...
  const replaceRows = React126.useCallback((firstRowToRender, newRows) => {
  ...
  const groupRows = React126.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React126.useCallback((methodName) => {
    if (methodName === "rowTreeCreation") {
      groupRows();
    }
  }, [groupRows]);
  const handleStrategyActivityChange = React126.useCallback(() => {
  ...
  const applyHydrateRowsProcessor = React126.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const isFirstRender = React126.useRef(true);
  React126.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
      return;
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const rowsHeightLookup = React127.useRef(/* @__PURE__ */ Object.create(null));
  const lastMeasuredRowIndex = React127.useRef(-1);
  const hasRowWithAutoHeight = React127.useRef(false);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  ...
  const hydrateRowsMeta = React127.useCallback(() => {
    var _pinnedRows$top, _pinnedRows$bottom;
  ...
  const getRowHeight = React127.useCallback((rowId) => {
  ...
  const setRowHeight = React127.useCallback((id, height) => {
    rowsHeightLookup.current[id].sizes.baseCenter = height;
    rowsHeightLookup.current[id].isResized = true;
    rowsHeightLookup.current[id].needsFirstMeasurement = false;
    hydrateRowsMeta();
  }, [hydrateRowsMeta]);
  const debouncedHydrateRowsMeta = React127.useMemo(() => debounce(hydrateRowsMeta, props.rowPositionsDebounceMs), [hydrateRowsMeta, props.rowPositionsDebounceMs]);
  const storeMeasuredRowHeight = React127.useCallback((id, height, position) => {
  ...
  const rowHasAutoHeight = React127.useCallback((id) => {
    var _rowsHeightLookup$cur2;
    return ((_rowsHeightLookup$cur2 = rowsHeightLookup.current[id]) == null ? void 0 : _rowsHeightLookup$cur2.autoHeight) || false;
  }, []);
  const getLastMeasuredRowIndex = React127.useCallback(() => {
    return lastMeasuredRowIndex.current;
  }, []);
  const setLastMeasuredRowIndex = React127.useCallback((index) => {
    if (hasRowWithAutoHeight.current && index > lastMeasuredRowIndex.current) {
      lastMeasuredRowIndex.current = index;
    }
  }, []);
  const resetRowHeights = React127.useCallback(() => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const sortColumn = React130.useCallback((column, direction, allowMultipleSorting) => {
    if (!column.sortable) {
      return;
    }
...
function useGridDimensions(apiRef, props) {
  ...
  const rootDimensionsRef = React132.useRef(null);
  const fullDimensionsRef = React132.useRef(null);
  const rowsMeta = useGridSelector(apiRef, gridRowsMetaSelector);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const rowHeight = Math.floor(props.rowHeight * densityFactor);
  const totalHeaderHeight = getTotalHeaderHeight(apiRef, props.columnHeaderHeight);
  const updateGridDimensionsRef = React132.useCallback(() => {
    var _apiRef$current$rootE;
  ...
  const getRootDimensions = React132.useCallback(() => fullDimensionsRef.current, []);
  ...
  const computeSizeAndPublishResizeEvent = React132.useCallback(() => {
...
var useGridStatePersistence = (apiRef) => {
  const exportState = React133.useCallback((params = {}) => {
    const stateToExport = apiRef.current.unstable_applyPipeProcessors("exportState", {}, params);
    return stateToExport;
  }, [apiRef]);
  const restoreState = React133.useCallback((stateToRestore) => {
...
//# sourceMappingURL=chunk-4Q2VP3AD.js.map
